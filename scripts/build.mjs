...
function renderAboutPage() {
  return `
    ...
    <section class="section-card" style="margin-top: 20px;">
      ...
      <div class="callout">${langPair("现在先放个人简介、KL Food Map、Voice Lab 和 Cardroom，后面再按同样方式往里接新项目，不需要重做整站结构。", "The profile, KL Food Map, Voice Lab, and Cardroom are the starting point. New projects can be added without rebuilding the site structure.")}</div>
    </section>
